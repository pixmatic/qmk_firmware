...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // Capa 1: Fn1 Hold (Macros / Multimedia / Control Brillo RGB)
    [1] = LAYOUT_iso_68(
        KC_GRV,  M_MAIL,  M_NAME,  M_SURN,  M_ADDR,  M_DNI,   M_TEL,   M_IBAN,  KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD,  KC_VOLU,          _______,
    ...
    [2] = LAYOUT_iso_68(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,                    SK_PGUP,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  SK_ENT,           SK_PGDW,
